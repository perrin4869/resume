...
\begin{position}
Working on the TechHarbor project in the Strategy unit. Main responsibilities are development, maintenance and deployment of the react-based frontend and the serverless-based graphql API.\\
