...
Working on the TechHarbor project in the Strategy unit. Main responsibilities are development, maintenance and deployment of the react-based frontend and the graphql API.\\
 ...
 \begin{itemize} \itemsep -2pt % reduce space between items
  ...
  \item Utilize DynamoDB to store user-defined searches and relevant information.
  ...
  \item Utilize S3 to store data exports over 5MB, which are over the limit of what AWS Lambda
    functions can return. Respond with an HTTP redirect.
